...
class UpsampleOverlap:
    ...
    """
    def __init__(self, input_sample_rate: int = 24000, input_format: str = 'int16'):
        """
        Args:
            input_sample_rate: Sample rate of input audio (24000 or 48000)
            input_format: Either 'int16' or 'float32'
        """
